...
sleep 3;
["Capture",2,_objDist,[true,false],[true,false,true],false,[20,10],[5,2],[0.8,0.8,0.7,0.7,0.6,1,1,1,1,0.9],nil,nil,1] execVM "LV\militarize.sqf";
...
[[[_cityNameStr],"script.sqf"], "BIS_fnc_execVM", true, false] call BIS_fnc_MP;
