//File: Charkia Capture (SQF)
//Author: Styx
//Description: Sets up the Charkia Capture Mission
...
sleep 3;
["Capture",2,_objDist,[true,false],[true,false,false],false,[20,10],[3,2],[0.8,0.8,0.7,0.7,0.6,1,1,1,1,0.9],nil,nil,1] execVM "LV\militarize.sqf";
["Capture",2,true,1,[20,10],_objDist,[0.8,0.8,0.7,0.7,0.6,1,1,1,1,0.9],nil,nil,2] execVM "LV\fillHouse.sqf";
sleep 10;
