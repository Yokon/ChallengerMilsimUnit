...
G_Respawn_Time = 3; //Amount of time (in seconds) dead unit must wait before being able to respawn (overrides description.ext setting)
...
G_Mobile_Respawn_WEST = [MobileRespawnWEST,MobileRespawnWEST_1]; 
